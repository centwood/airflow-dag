...
with DAG(dag_id='cloud_iqx_runtime_psql_dag',
         default_args={'owner': 'airflow'},
         schedule_interval='@daily',
         start_date=days_ago(1)
    ) as dag:

    execute_sql_function_truncate_staging_table = PostgresOperator(
        task_id='execute_sql_function_truncate_staging_table',
    ...
    execute_sql_function_update_working_table = PostgresOperator(
        task_id='execute_sql_function_update_working_table',
        #AIRFLOW_CONN_POSTGRES_MASTER = pgurl,
        postgres_conn_id='cloud_runtime_psql',
        sql='''
        call insert_cloud_runtime_job_test();
    ...
    execute_sql_function_truncate_staging_table >> execute_sql_function_insert_to_table >> execute_sql_function_update_working_table
